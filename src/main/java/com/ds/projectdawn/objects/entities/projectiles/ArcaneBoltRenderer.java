...
public class ArcaneBoltRenderer extends EntityRenderer<ArcaneBoltEntity>
{
    ...
    public ArcaneBoltRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(ArcaneBoltEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ArcaneBoltEntity entity) { return MAGIC_ORB_TEXTURE; }
