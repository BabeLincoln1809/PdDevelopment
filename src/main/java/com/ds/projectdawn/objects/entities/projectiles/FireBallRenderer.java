...
{
    private static final ResourceLocation FIREBALL_TEXTURE = new ResourceLocation("minecraft:textures/item/fire_charge.png");
    private static final RenderType fireball_render = RenderType.entityCutoutNoCull(FIREBALL_TEXTURE);

    public FireBallRenderer(EntityRendererManager renderManagerIn) {
    ...
    public void render(FireBallEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        IVertexBuilder ivertexbuilder = bufferIn.getBuffer(fireball_render);
    ...
    @Override
    public ResourceLocation getTextureLocation(FireBallEntity entity) { return FIREBALL_TEXTURE; }
