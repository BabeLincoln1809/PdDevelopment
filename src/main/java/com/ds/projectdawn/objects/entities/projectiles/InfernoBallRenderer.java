...
@OnlyIn(Dist.CLIENT)
public class InfernoBallRenderer extends EntityRenderer<InfernoBallEntity>
{
    private static final ResourceLocation INFERNOBALL_TEXTURE = new ResourceLocation("minecraft:textures/item/fire_charge.png");
    private static final RenderType infernoball_render = RenderType.entityCutoutNoCull(INFERNOBALL_TEXTURE);

    public InfernoBallRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(InfernoBallEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        IVertexBuilder ivertexbuilder = bufferIn.getBuffer(infernoball_render);
    ...
    @Override
    public ResourceLocation getTextureLocation(InfernoBallEntity entity) { return INFERNOBALL_TEXTURE; }
