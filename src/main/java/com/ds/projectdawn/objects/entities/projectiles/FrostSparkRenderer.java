...
@OnlyIn(Dist.CLIENT)
public class FrostSparkRenderer extends EntityRenderer<FrostSparkEntity>
{
    private static final ResourceLocation FROSTSPARK_TEXTURE = new ResourceLocation("projectdawn:textures/entity/projectile/ice_orb.png");
    private static final RenderType frostspark_render = RenderType.entityCutoutNoCull(FROSTSPARK_TEXTURE);

    public FrostSparkRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(FrostSparkEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        IVertexBuilder ivertexbuilder = bufferIn.getBuffer(frostspark_render);
    ...
    @Override
    public ResourceLocation getTextureLocation(FrostSparkEntity entity) { return FROSTSPARK_TEXTURE; }
