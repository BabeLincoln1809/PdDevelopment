...
@OnlyIn(Dist.CLIENT)
public class VoidChargeRenderer extends EntityRenderer<VoidChargeEntity>
{
    private static final ResourceLocation VOIDCHARGE_TEXTURE = new ResourceLocation("projectdawn:textures/entity/projectile/void_charge.png");
    private static final RenderType voidcharge_render = RenderType.entityCutoutNoCull(VOIDCHARGE_TEXTURE);

    public VoidChargeRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(VoidChargeEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        IVertexBuilder ivertexbuilder = bufferIn.getBuffer(voidcharge_render);
    ...
    @Override
    public ResourceLocation getTextureLocation(VoidChargeEntity entity) { return VOIDCHARGE_TEXTURE; }
