...
@OnlyIn(Dist.CLIENT)
public class SoulChargeRenderer extends EntityRenderer<SoulChargeEntity>
{
    private static final ResourceLocation SOULCHARGE_TEXTURE = new ResourceLocation("projectdawn:textures/entity/projectile/soulcharge.png");
    private static final RenderType soulcharge_render = RenderType.entityCutoutNoCull(SOULCHARGE_TEXTURE);

    public SoulChargeRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(SoulChargeEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        IVertexBuilder ivertexbuilder = bufferIn.getBuffer(soulcharge_render);
    ...
    @Override
    public ResourceLocation getTextureLocation(SoulChargeEntity entity) { return SOULCHARGE_TEXTURE; }
